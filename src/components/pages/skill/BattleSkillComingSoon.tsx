      ...
      >
         ...
         <div className="flex items-center justify-center gap-4">
            <a href="https://telegram.org" target="_blank">
               <Image
                  src="/enian-combat.github.io/assets/social-media/telegram-bubble.png"
            ...
            <a href="https://x.com" target="_blank">
               <Image
                  src="/enian-combat.github.io/assets/social-media/x-bubble.png"
                  className="h-[52px] w-[52px]"
                  alt="x-bubble"
               />
            </a>
            <a href="https://discord.com" target="_blank">
               <Image
                  src="/enian-combat.github.io/assets/social-media/discord-bubble.png"
                  className="h-[52px] w-[52px]"
                  alt="discord-bubble"
               />
            </a>
